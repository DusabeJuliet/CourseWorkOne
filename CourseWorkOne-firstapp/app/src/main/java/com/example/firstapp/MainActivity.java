...
//
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IntentFilter intentFilter = new IntentFilter("com.example.firstapp");
        julie = new Receiver();
        registerReceiver(julie, intentFilter);
   ...
   class Receiver extends BroadcastReceiver {
    public void onReceive(Context context, Intent intent){
        ...
        if (intent.getAction().equals("com.example.firstapp")) {
            // Display message
