...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button broadcastsender = new Button(this);
        broadcastsender.setText("BroadCast");
        ...
        broadcastsender.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String message="My Broadcast Message";
                    String m = "hello App two";
                    Intent intent = new Intent();
                    intent.setAction("com.com.example.firstapp");
